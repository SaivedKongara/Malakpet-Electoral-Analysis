...
Demographic–vote correlation — Booth/area-level demographic composition (from the extracted voter data) is correlated against party vote share (CORREL/SLOPE) to identify areas of demographic concentration associated with particular parties' vote strength. This is an ecological-level association, not an individual-level claim — see Limitations.
...
Saivedkongara — BBA, IBS Hyderabad (ICFAI)
